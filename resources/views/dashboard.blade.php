...
<!-- Content Header (Page header) -->
    ...
    <div class="box box-success">
        ...
        <div class="box-body chat" id="chat-box">
            <!-- chat item -->
            <div class="item">
                <img src="/public/bower_components/AdminLTE/dist/img/avatar.png" alt="user image" class="online"/>
            ...
            <!-- chat item -->
            <div class="item">
                <img src="/public/bower_components/AdminLTE/dist/img/avatar2.png" alt="user image" class="offline"/>
            ...
            <!-- chat item -->
            <div class="item">
                <img src="/public/bower_components/AdminLTE/dist/img/avatar3.png" alt="user image" class="offline"/>
