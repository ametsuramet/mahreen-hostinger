            ...
            <div class="box-header">
              ...
              <input type="hidden" value="{!! csrf_token() !!}" name="_token">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control "  name="title" placeholder="ex title" value="{!! $category->title !!}">
                </div>

                <div class="form-group">
                  <label for="slug">Slug</label>
                  <input type="text" class="form-control "  name="slug" placeholder="ex slug" value="{!! $category->slug !!}">
                </div>
